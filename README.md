# DSMovie - Listagem e avaliação de filmes.

<ol align="left">
 <li><strong><a href="#--sobre-projeto">Sobre</a></strong></li>
...
### [](#--frontend) 🎨 Aprendizados Front-end
...
```shell
# clonar repositório
git clone https://github.com/Gabriel-developer-01/dsmovie.git

1. Abra a pasta backend em uma IDE java(Spring boot, Intellij e etc);
2. Instale as dependências do maven;
3. Execute o arquivo projeto
```
